...
export default function GapDischargeWithoutReadmissionPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-discharge-without-readmission/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Discharge without '/readmission</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Discharge without /readmission-risk (flag high-risk discharges for extra follow-up)</p>
