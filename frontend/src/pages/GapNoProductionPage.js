...
export default function GapNoProductionPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-production/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No production</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No production-grade EHR integration (Epic, Cerner) despite integrations.js stub</p>
