...
// Gap (Non-AI): No notifications layer dedicated to clinical alerts
// No notifications layer dedicated to clinical alerts
import React, { useState } from 'react';

export default function GapNoNotificationsLayerDedicatedToClinicalAlertPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-notifications-layer-dedicated-to-clinical-alert/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No notifications layer dedicated to clinical alerts</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No notifications layer dedicated to clinical alerts</p>
