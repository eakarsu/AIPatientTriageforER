...
// Gap (Non-AI): No file upload for imaging/lab attachments visible
// No file upload for imaging/lab attachments visible
import React, { useState } from 'react';

export default function GapNoFileUploadForImagingLabAttachmentsVisiblePage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-file-upload-for-imaging-lab-attachments-visible/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No file upload for imaging/lab attachments visible</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No file upload for imaging/lab attachments visible</p>
