...
export default function CFAgenticErFlowOptimizationPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-agentic-er-flow-optimization/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Agentic ER flow optimization</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Agentic ER flow optimization: Autonomous background process predicts bottlenecks 2-4 hours ahead; pre-stages resources; auto-escalates slow cases; coordinates with ICU/wards for discharge timing</p>
