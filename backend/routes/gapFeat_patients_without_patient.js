...
// Patients without /patient-history-summarize (AI reads full chart; generates 1-page summary)
...
async function callLLM(systemPrompt, userPrompt) {
  ...
  const res = await fetchFn('https://openrouter.ai/api/v1/chat/completions', {
    ...
    headers: {
      ...
      'X-Title': 'AIPatientTriageforER / gap-patients-without-patient',
    },
    body: JSON.stringify({
